  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-zinc-400"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path><line x1="9" y1="14" x2="15" y2="14"></line></svg>
          <span className={`text-zinc-400 text-[10px] md:text-xs tracking-widest font-bold mt-0.5 ${outfitFont.className}`} dir="ltr">
            PROJECT NOT FOUND
          </span>
        </motion.div>

        {/* عدد 404 بزرگ با افکت */}
        <motion.div
        ...
        >
          <h1 
            className={`text-[100px] md:text-[160px] font-black leading-none text-white tracking-tighter select-none ${orbitronFont.className}`}
        ...
        <motion.div
          ...
          className="flex flex-col gap-3 mt-2 mb-10"
        >
          ...
          <p className="text-zinc-500 text-sm md:text-base max-w-md mx-auto leading-relaxed font-light">
            به نظر می‌رسد این نمونه‌کار از سرور استودیو پاک شده، آدرس آن تغییر کرده یا در حال حاضر در دسترسی نیست.
          </p>
        </motion.div>
        ...
        >
          ...
          {/* نکته: اگه تو سایتت صفحه اختصاصی پورتفولیو داری (مثل /works)، آدرس href پایین رو به اون تغییر بده */}
          <Link 
            href="/#works" // یا "/works"
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-zinc-500 group-hover:text-white transition-colors"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
